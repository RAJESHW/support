...
import IteratableCards from "./Components/IteratableCards.js"
  ...
  render() {
    return (
      <div className="App">
        ...
        <IteratableCards cardsClass={'gw-green-dark'} whichCard={'green'} />
        <div className="small-24">
        ...
        <IteratableCards cardsClass={'gw-blue'} whichCard={'blue'}/>
        <div className="small-24">
